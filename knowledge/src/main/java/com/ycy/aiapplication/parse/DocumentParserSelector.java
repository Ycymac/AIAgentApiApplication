package com.ycy.aiapplication.parse;
 ...
 * 支持两种选择方式：
 * <ul>
 *   <li>按类型选择：通过 {@link #select(String)} 指定解析器类型（如 {@link com.ycy.aiapplication.parse.common.ParserType#TIKA},
 *   {@link com.ycy.aiapplication.parse.common.ParserType#MARKDOWN}）</li>
...
public class DocumentParserSelector {
     ...
     * 根据解析器类型选择解析策略
     *
     * @param parserType 解析器类型（如 {@link com.ycy.aiapplication.parse.common.ParserType#TIKA}, {@link com.ycy.aiapplication.parse.common.ParserType#MARKDOWN}）
